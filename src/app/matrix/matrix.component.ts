...
export class MatrixComponent implements OnInit {
  ...
  initPlayers() {
    // Player1
    var player1 = new PlayerComponent();
    player1.bot = false;

    // Bot
    var player2 = new PlayerComponent();
...
checkOneFourSeven()
{
 ...
 if(  block4.free == false && block7.free == false && block1.free == true  && (block4.value == block7.value) ) {
    return true;
 }
 return false;
...
GetCompletingSet() {
    ...
    // Block#2
        ...
        return 1;
    } else if( block2.free == true && block8.free == false && block5.free == false && ( block5.value == 'cross' && block5.value == block8.value) ) {
        return 2;
    ...
    // Block#3
        ...
        return 9;
    } else if( block3.free == true && block5.free == false && block7.free == false && ( block5.value == 'cross' && block5.value == block7.value) ) {
        return 3;
...
blockEnemyAttemptCompleteSet() {
    ...
    if( block1.free == false && block2.free == true && block3.free == false && (block1.value == block3.value) ) {
        ...
        return 9;
    } else if( block1.free == true && block5.free == false && block9.free == false && (block5.value == block9.value) ) {
        return 1;
    ...
    // Block#2
        ...
        return 1;
    } else if( block2.free == true && block8.free == false && block5.free == false && (block5.value == block8.value) ) {
        return 2;
    ...
    // Block#3
        ...
        return 9;
    } else if( block3.free == true && block5.free == false && block7.free == false && (block5.value == block7.value) ) {
        return 3;
